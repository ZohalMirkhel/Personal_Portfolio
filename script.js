...
document.addEventListener("DOMContentLoaded", () => {
  ...
  heroImage.innerHTML = `
      <img src="images/home.jpeg" alt="Zohal Mirkhel working on a laptop">
  `;
  ...
  aboutMe.innerHTML = `
    <div class="about-section">
      <div class="about-image">
        <img src="images/about.png" alt="Zohal Mirkhel">
      </div>
      <div class="about-text" style="overflow: hidden;">
...
if (skillsSection) {
  const skills = {
    ...
    tools: ["Git", "GitHub"],
    certificates: [
      { name: "Responsive Web Design", image: "certificates/responsivewebdesgin.PNG" },
      { name: "JavaScript Algorithms and Data Structure", image: "certificates/JS.PNG" },
      { name: "Capacity Building", image: "certificates/CB.jpg" },
      { name: "Introduction to Coding and Web Development", image: "certificates/ITCWD.jpg" },
      { name: "Virtual Advance Coding", image: "certificates/SOW.jpg" },
      { name: "Instructional Design", image: "certificates/Certificate.PNG" }
    ],
  };
...
if (myProjects && popUp && popupContent && closePop) {
  const projects = [
    ...
    },
    {
      ...
      shortDescription: "This project is an e-commerce website dedicated to showcasing and selling traditional Afghan clothing and accessories. It features a responsive design, easy-to-use navigation, product listings with images and descriptions, an email subscription form, and a search bar.",
  ...
  myProjects.innerHTML = projects
    ...
    <div class="proj">
      ...
      <button onclick="showPopup(${index})">See More</button>
    </div>`
    )
    .join("");
